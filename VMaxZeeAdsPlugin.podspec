#
# Be sure to run `pod lib lint VMaxZeeAdsPlugin.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of VMaxZeeAdsPlugin.'
...
TODO: Add long description of the pod here.
  ...
  s.author           = { 'CloyMonisVMax' => 'cloy.m@vmax.com' }
  ...
  # s.resource_bundles = {
  #   'VMaxZeeAdsPlugin' => ['VMaxZeeAdsPlugin/Assets/*.png']
  # }
